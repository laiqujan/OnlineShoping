<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckOut.aspx.cs" Inherits="OnlineShoping.CheckOut" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <h1 style="margin-left:160px;color:steelblue;font-style:italic;font-size:20px;text-decoration:underline;">Your Order has been conformed with the Following details and will be shipped to you with 7 days...</h1>
        <br />
        <div style="margin-left:170px; width: 998px;">
       ...
       <br />
        ...
        <table style="margin-left:270px; height: 269px; width: 44%;" cellpadding="2px">
            <th class="auto-style1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;INFORMATION</th>
            <th class="auto-style1">EXTRAS</th><th class="auto-style1">
            <br />
            CUSTOMER 
            <br />
